# -*- coding: utf-8 -*-
"""
Created on Tue Mar  6 09:29:00 2018

@author: mc.meng

data url:https://www.google.org/flutrends/data.txt
"""
...
flutrends = np.loadtxt("goog_flutends.csv", delimiter=',', usecols=(1,), skiprows=1, converters = {1: lambda s:float(s or 0)}, unpack=True)
N = len(flutrends)
...
print("Normal Values Andersono", anderson(normal_values))
